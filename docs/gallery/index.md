...
Figures are reproduced from internal benchmark runs for **visualisation and portfolio purposes** only. They do not include solver source code or full simulation archives.

Related: [Quick Start](../quickstart.md) · [Theory](../theory/index.md)
